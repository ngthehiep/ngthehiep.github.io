...
// manual slide select
let slider_controls = slider.querySelectorAll('.slider-control-item')
slider_controls.forEach((item, index) => {
    item.addEventListener('click', () => showSlide(index))
})


// mobile menu  toggle
let menu_toggle = document.querySelector('#mb-menu-toggle')
